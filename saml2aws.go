...
import (
	...
	"github.com/gngj/saml2aws/v2/pkg/provider/aad"
	"github.com/gngj/saml2aws/v2/pkg/provider/adfs"
	"github.com/gngj/saml2aws/v2/pkg/provider/adfs2"
	"github.com/gngj/saml2aws/v2/pkg/provider/akamai"
	"github.com/gngj/saml2aws/v2/pkg/provider/auth0"
	"github.com/gngj/saml2aws/v2/pkg/provider/browser"
	"github.com/gngj/saml2aws/v2/pkg/provider/f5apm"
	"github.com/gngj/saml2aws/v2/pkg/provider/googleapps"
	"github.com/gngj/saml2aws/v2/pkg/provider/jumpcloud"
	"github.com/gngj/saml2aws/v2/pkg/provider/keycloak"
	"github.com/gngj/saml2aws/v2/pkg/provider/netiq"
	"github.com/gngj/saml2aws/v2/pkg/provider/okta"
	"github.com/gngj/saml2aws/v2/pkg/provider/onelogin"
	"github.com/gngj/saml2aws/v2/pkg/provider/pingfed"
	"github.com/gngj/saml2aws/v2/pkg/provider/pingone"
	"github.com/gngj/saml2aws/v2/pkg/provider/shell"
	"github.com/gngj/saml2aws/v2/pkg/provider/shibboleth"
	"github.com/gngj/saml2aws/v2/pkg/provider/shibbolethecp"
)
